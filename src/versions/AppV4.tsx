...
function AppV4({ currentVersion, onVersionChange, versions }: VersionProps) {
                       ...
                       return (
                         <div key={product.id} style={{ display: "flex", flexDirection: "column", padding: "20px 32px", borderTop: index > 0 ? `1px solid ${tokens.colorNeutralStroke2}` : "none" }}>
                           ...
                           <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
                             ...
                             <p style={{ fontSize: "20px", lineHeight: "28px", color: tokens.colorNeutralForeground1, margin: 0, fontWeight: 700, whiteSpace: "nowrap", flexShrink: 0 }}>
                               {agentCredits}
                             </p>
                           </div>
                           ...
                           {/* Bottom row: expand toggle + action buttons */}
                           <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                             <div
                             ...
                             <div style={{ display: "flex", flexDirection: "column", gap: "16px", marginTop: "12px", paddingTop: "12px", borderTop: `1px solid ${tokens.colorNeutralStroke2}` }}>
                               ...
                               <div className={styles.calcSectionContainer}>
                                 <div style={{ display: "flex", alignItems: "baseline", gap: "8px", width: "100%" }}>
                                   ...
                                   <span className={styles.calcLeader} />
                                   <p style={{ fontSize: "14px", fontWeight: 600, color: tokens.colorNeutralForeground1, margin: 0, flexShrink: 0, whiteSpace: "nowrap" }}>{(researchCredits * multiplier).toLocaleString()}</p>
                                 </div>
                                 <div className={styles.calcItemRow}>
                                   <p className={styles.calcItemLabel}>Research credits</p>
                                   <span className={styles.calcLeader} />
                                   <p className={styles.calcItemValue}>{(researchCredits * multiplier).toLocaleString()}</p>
                                 </div>
                               </div>
                               ...
                               <div className={styles.calcSectionContainer}>
                                 <div style={{ display: "flex", alignItems: "baseline", gap: "8px", width: "100%" }}>
                                   ...
                                   <span className={styles.calcLeader} />
                                   <p style={{ fontSize: "14px", fontWeight: 600, color: tokens.colorNeutralForeground1, margin: 0, flexShrink: 0, whiteSpace: "nowrap" }}>{(engagementCredits * multiplier).toLocaleString()}</p>
                                 </div>
                                 <div className={styles.calcItemRow}>
                                   <p className={styles.calcItemLabel}>Engagement credits</p>
                                   <span className={styles.calcLeader} />
                                   <p className={styles.calcItemValue}>{(engagementCredits * multiplier).toLocaleString()}</p>
                                 </div>
                               </div>
                               </>) : isCaseMgmt ? (<>
                          ...
                          <div key={product.id} style={{
                            ...
                            <div className={styles.calcSectionContainer}>
                              <div style={{ display: "flex", alignItems: "baseline", gap: "8px", width: "100%" }}>
                                <h3 className={styles.h4Title}>Estimate for generative answers</h3>
                                <span className={styles.calcLeader} />
                                <p style={{ fontSize: "14px", fontWeight: 600, color: tokens.colorNeutralForeground1, margin: 0, flexShrink: 0, whiteSpace: "nowrap" }}>{(cmGenAnswersCredits * timeMultiplier).toLocaleString()}</p>
                              </div>
                              <div className={styles.calcItemRow}>
                                <p className={styles.calcItemLabel}>Generative answers credits</p>
                                <span className={styles.calcLeader} />
                            ...
                            <div className={styles.calcSectionContainer}>
                              <div style={{ display: "flex", alignItems: "baseline", gap: "8px", width: "100%" }}>
                                <h3 className={styles.h4Title}>Estimate for classic answers</h3>
                                <span className={styles.calcLeader} />
                                <p style={{ fontSize: "14px", fontWeight: 600, color: tokens.colorNeutralForeground1, margin: 0, flexShrink: 0, whiteSpace: "nowrap" }}>{(cmClassicAnswersCredits * timeMultiplier).toLocaleString()}</p>
                              </div>
                              <div className={styles.calcItemRow}>
                                <p className={styles.calcItemLabel}>Classic answers credits</p>
                                <span className={styles.calcLeader} />
                            ...
                            <div className={styles.calcSectionContainer}>
                              <div style={{ display: "flex", alignItems: "baseline", gap: "8px", width: "100%" }}>
                                <h3 className={styles.h4Title}>Estimate for text and generative AI tools (standard)</h3>
                                <span className={styles.calcLeader} />
                                <p style={{ fontSize: "14px", fontWeight: 600, color: tokens.colorNeutralForeground1, margin: 0, flexShrink: 0, whiteSpace: "nowrap" }}>{(cmTextToolsCredits * timeMultiplier).toLocaleString()}</p>
                              </div>
                              <div className={styles.calcItemRow}>
                                <p className={styles.calcItemLabel}>Text and AI tools credits</p>
                                <span className={styles.calcLeader} />
